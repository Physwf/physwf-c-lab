// RacorX.cpp : Defines the entry point for the application.
//
#include "RacorX.h"
/*
#include "stdafx.h"
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_RACORX, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_RACORX));
...
std::shared_ptr<CD3DApplication> CD3DApplication::Instance = nullptr;
