...
//  is.pbInBuffer  = (unsigned char *)pbInBuffer;
    is.dwBitBuff   = LITTLEENDIAN32BITS(*(unsigned long *)pbInBuffer);
...
int Compress_bzip2(char * pbOutBuffer, int * pdwOutLength, char * pbInBuffer, int dwInLength, int * pCmpType, int nCmpLevel)
{
    ...
    *pdwOutLength = 0;
    ...
    if(BZ2_bzCompressInit(&strm, blockSize100k, 0, nCmpLevel) == 0)
    {
...
{
    {0x40, Compress_wave_mono},         // IMA ADPCM mono compression
    {0x80, Compress_wave_stereo},       // IMA ADPCM stereo compression
    ...
    {0x10, Compress_bzip2}              // Compression Bzip2 library
};
...
{
    {0x10, Decompress_bzip2},           // Decompression with Bzip2 library
    ...
    {0x80, Decompress_wave_stereo},     // IMA ADPCM stereo decompression
    {0x40, Decompress_wave_mono}        // IMA ADPCM mono decompression
};
