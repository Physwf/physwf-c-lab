...
//#define MPQ_FILE_COMPRESS1     0x00000100 // For compatibility with older sources (DON'T USE !!)
#define MPQ_FILE_COMPRESS_MULTI  0x00000200 // Multiple compressions
//#define MPQ_FILE_COMPRESS2     0x00000200 // For compatibility with older sources (DON'T USE !!)
...
#define MPQ_FILE_02000000        0x02000000 // The file is only 1 byte long and its name is a hash
#define MPQ_FILE_04000000        0x04000000 // Appears in WoW 1.10 or newer, dunno what does it mean
...
#define STORMLIB_VERSION      (0x050A)      // Current version of StormLib
